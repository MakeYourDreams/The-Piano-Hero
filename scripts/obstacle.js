class Obstacle extends Component {
    constructor(game, oNote, oDelta, oVelocity) {
        ...
        if (oNote >= 439.9) this.x = 95, this.pKey = 49, this.kColor = "#0F9D58", this.noteIndex = "n1";  
        ...
        if (oNote >= 879) this.x = 95, this.pKey = 49, this.kColor = "#0F9D58", this.noteIndex = "n1"; 
        ...
        if (oNote >= 1759) this.x = 95, this.pKey = 49, this.kColor = "#0F9D58", this.noteIndex = "n1"; 
